...
return (
    <div 
      className="min-h-screen relative overflow-hidden bg-black w-full" // Added w-full
      style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.60), rgba(0, 0, 0, 0.70)), url("/azores1.jpeg")`,
    ...
    >
      <div className="h-screen flex items-center justify-center px-4">
        <AnimatePresence initial={false} custom={direction} mode="wait">
          ...
          >
        <div className="bg-black/40 backdrop-filter backdrop-blur-none rounded-2xl p-6 max-w-lg mx-auto">
              <motion.p 
